...
(function (Z) {
    ...
    function ba(b, d, f) {
        n([["toUrl"], ["undef"], ["defined", "requireDefined"], ["specified", "requireSpecified"]], function (g) {
    ...
    if (typeof define === "undefined") {
        ...
        m.isBrowser = x;
        w = m.s = {
            contexts: u, newContext: function (b) {
                function d(a, c, j) {
                ...
                var k = {
                    ...
                    pkgs: {},
                    shim: {}
                }, o = {}, X = {}, D = [], p = {}, O = {}, Q = {}, L = 1, N = 1, K = [], U, Y, i, P, V;
                P = {
                    require: function (a) {
                        return u(a)
                    }, exports: function (a) {
                    ...
                    configure: function (a) {
                        ...
                        if (a.packages)n(a.packages, function (a) {
                            ...
                            b[a.name] = {
                                ...
                                main: (a.main || "main").replace(ka, "").replace(ca, "")
                            }
                        }), k.pkgs =
                            b;
