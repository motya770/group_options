...
<t:sitepage>
    <jsp:body>
        <script>
            $(function () {
                Customer.loadUnfinishedPositions();
            });
        </script>
                ...
                <div class="failed">
                    <table class="failed-positions-container table table-bordered table-hover">
                        <tr class="failed-position">
                            ...
                            <th><s:message code="customer.unfinished.tradeStart" text="Message not found"/></th>
                            <th><s:message code="customer.unfinished.tradeEnd"  text="Message not found" /></th>
