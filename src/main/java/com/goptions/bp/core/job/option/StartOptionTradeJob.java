 ...
 */
public class StartOptionTradeJob extends GeneralJob {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        try {
            ...
            coreOptionJobManager.startOptionTradeExecute(entityId);

        } catch (Exception e) {
            e.printStackTrace();
            logger.error("{}", e);
            throw new JobExecutionException("Exception in StartOptionTradeJob ", e);
        }
    }
}